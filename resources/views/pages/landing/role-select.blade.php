...
<body>
    <main class="p-14 w-full min-h-screen bg-cover bg-center bg-no-repeat " style="background-image: url('assets/images/bg-auth.png');">
        ...
        <div class="w-full h-auto flex flex-col justify-center items-center">
            ...
            <p class="md:text-md text-sm text-[#686868]">Sudah punya akun?<span class="text-primary font-semibold"><a href="#"> Login</a></span></p>
